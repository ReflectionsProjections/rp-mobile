...
import { View, ScrollView, Image, Dimensions, NativeSyntheticEvent, NativeScrollEvent } from 'react-native';
...
const ImageCarousel = () => {
    ...
    return (
        <View className="items-center my-4">
            ...
            >
                {images.map((src, i) => (
                    <Image key={i} source={src} style={{ width: IMAGE_SIZE, height: IMAGE_SIZE, borderRadius: 8 }} />
                ))}
            </ScrollView>
