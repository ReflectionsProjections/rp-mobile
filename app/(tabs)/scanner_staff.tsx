    ...
    <SafeAreaView className="flex-1 bg-black">
      ...
      <View className="flex-1 relative">
        <CameraView
          ...
          style={{ flex: 1 }}
          facing="back"
          onBarcodeScanned={scanReady && !scanned ? handleBarCodeScanned : undefined}
        >
          {!loading && !scanned && (
            <View className="absolute inset-0 justify-center items-center z-10 px-4">
              {!scanReady ? (
                <Text className="text-green-500 text-lg font-bold">Tap the box to prepare</Text>
              ) : (
                <TouchableOpacity className="bg-[#00adb5] px-6 py-3 rounded-lg" onPress={() => {}}>
        ...
        {scanned && !loading && (
          <View className="absolute inset-0 justify-center items-center bg-black/40 z-20">
            ...
            <TouchableOpacity className="bg-[#00adb5] px-6 py-3 rounded-lg" onPress={resetScan}>
