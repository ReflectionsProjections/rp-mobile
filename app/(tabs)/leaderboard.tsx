...
import Reanimated, { useSharedValue, withRepeat, withTiming, useAnimatedStyle, Easing } from 'react-native-reanimated';
...
const LeaderboardScreen = () => {
    ...
    const handleRankPress = () => {
        ...
        const userIndex = (activeTab === 0 ? dailyLeaderboardData : globalLeaderboardData)
            .findIndex(p => p.name === userName);
                                ...
                                >
                                    <View>
                                        <Text style={{
                                            ...
                                            You are <Text style={{ color: '#CA2523' }}>#{activeTab === 0 ? dailyUserRank : globalUserRank}</Text>
                                        </Text>
                                    </View>
                                    <Text style={{
                                        color: '#fff',
                                        ...
                                        <Text style={{ color: '#CA2523', fontSize: 24 }}>{activeTab === 0 ? dailyPoints : globalPoints}</Text> LAP POINTS
                                    </Text>
                                    <Reanimated.View style={[{ flexDirection: 'row', alignItems: 'center', marginTop: 6, opacity: 0.9 }, pulseStyle]} >
                                        <Ionicons name="chevron-down" size={16} color="#fff" style={{ marginRight: 4 }} />
                                        <Text style={{ color: '#fff', fontSize: 13, fontFamily: 'magistral-medium' }}>Tap to jump</Text>
                                    </Reanimated.View>
                                </Pressable>
                            </FadeInWrapper>
                        </View>
